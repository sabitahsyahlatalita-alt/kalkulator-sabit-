...
ak2 = Button(root,text="sq2",padx=30,pady=20,command=akar)
sisa = Button(root,text="//2",padx=20,pady=20,command=sisabagi)
pang = Button(root,text="x2",padx=30,pady=20,command=pangkat)
...
hap = Button(root,text="C",padx=30,bg="#ff0000",pady=20,command=hapus)
sama = Button(root,text="=",padx=30,bg="#00fd26",pady=20,command=samadengan)
